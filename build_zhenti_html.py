...
NAV_CSS = "nav-embed.css?v=20260829af"
...
CSS = """
:root{--red:#c0142c;--red-d:#9b0f22;--bg:#fbf6f3;--card:#fff;
 --ink:#2a2326;--mut:#8a7a7a;--line:#efdcd4;--grn:#1f8a4c;--amb:#b9751a;--blu:#2b5fb0}
*{box-sizing:border-box}
body{margin:0;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Microsoft YaHei",sans-serif;
 background:var(--bg);color:var(--ink);line-height:1.75;-webkit-text-size-adjust:100%}
.page-head{background:linear-gradient(135deg,var(--red),var(--red-d));color:#fff;padding:24px 18px 20px}
.page-head h1{margin:0 0 6px;font-size:23px;letter-spacing:.5px;line-height:1.4}
.page-head .sub{font-size:13.5px;opacity:.93;max-width:900px}
.wrap{max-width:980px;margin:0 auto;padding:16px 14px 60px}
.notice{background:#fff8e8;border:1px solid #f0dcae;border-radius:12px;padding:12px 14px;margin:14px 0;font-size:13.5px;color:#6b5216}
.notice b{color:#8a5a00}
...
.zt-card{background:var(--card);border:1px solid var(--line);border-radius:12px;padding:14px 15px;margin-bottom:13px;
 box-shadow:0 1px 2px rgba(150,20,40,.04)}
.zt-head{display:flex;flex-wrap:wrap;gap:6px;align-items:center;margin-bottom:10px}
.zt-badge{font-size:11.5px;padding:2px 9px;border-radius:20px;background:#fbe3dc;color:var(--red-d);border:1px solid #f3c9bd;white-space:nowrap}
...
.zt-stem{font-size:15px;margin:2px 0 10px}
.zt-stem p{margin:7px 0}
.zt-stem strong{color:var(--red-d)}
.zq{margin:8px 0;padding:8px 12px;border-left:3px solid var(--red);background:#fdf6f4;color:#3a3033}
...
.mdtable th{background:#fbf1ee;color:var(--red-d)}
.zt-ans{margin-top:8px;border-top:1px dashed var(--line);padding-top:8px}
.zt-ans summary{cursor:pointer;font-size:14px;color:var(--red-d);font-weight:600;padding:4px 0;list-style:none}
...
.zt-none{font-size:13.5px;color:var(--amb);background:#fff8ec;border:1px dashed #f0dcae;border-radius:8px;padding:8px 10px;margin-top:6px}
...
.zt-foot a{color:var(--red-d);text-decoration:none}
