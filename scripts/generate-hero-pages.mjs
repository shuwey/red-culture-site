 ...
 * 修改任何 hero 页面，请直接手工编辑对应的 hero-*.html，勿用本生成器。
 * 本文件仅保留为内容数据源(HEROES 数组)的归档参考。
 * ========================================================================== */
...
if (typeof process !== "undefined") {
  console.error("✋ generate-hero-pages.mjs 已被禁用：请手工编辑对应的 hero-*.html，勿运行本生成器。");
  process.exit(1);
}
...
const HEROES = [
  ...
  },
  {
    ...
    years: "1940 — 1962",
    native: "湖南长沙",
    epithet: "助人为乐 · 把有限的生命投入到无限的为人民服务之中",
    lead:
      "雷锋，湖南长沙人，中国人民解放军沈阳部队某部运输连班长。他出身贫苦、自幼丧母，在新中国成长起来，把「为人民服务」当作一生的信条，做了大量看似平凡却温暖他人的好事。",
    quote: "人的生命是有限的，可是，为人民服务是无限的，我要把有限的生命，投入到无限的为人民服务之中去。",
    quoteNote: "—— 雷锋日记（一九六二年八月十日）",
    stories: [
      {
        t: "新中国的成长",
        p: "雷锋不满七岁就成了孤儿，在党和政府的关怀下长大。1956 年他在荷叶坝完小毕业后回乡参加农业生产，而后到鞍钢做工人，再到部队服役——他曾说：「党像母亲一样把我拉扯大。」",
      },
      {
        t: "出差一千里，好事一火车",
        p: "在部队这个「大熔炉」里，他助人为乐不留名，送迷路老人回家、雨天背小孩过河、为战友缝补衣裳……出差路上，他沿途帮列车员扫地擦窗、为旅客倒水，所在班被命名为「雷锋班」。",
      },
      {
        t: "螺丝钉与日记",
        p: "他以「螺丝钉」自勉，在平凡岗位上默默奉献。他写下大量日记，留下对学习、对工作、对他人朴素而真诚的思考，那句「对待同志要像春天般的温暖」成为几代人共同的精神底色。",
      },
    ],
    legacy: "1962 年 8 月 15 日，他因公殉职，年仅二十二岁。毛泽东等老一辈革命家为他题词，号召全国人民「向雷锋同志学习」。半个多世纪以来，每年三月五日「学雷锋纪念日」从未中断。",
  },
  {
    slug: "jiaoyulu",
    name: "焦裕禄",
    years: "1922 — 1964",
    native: "山东博山",
    epithet: "县委书记的榜样 · 兰考人民的好书记",
    lead:
      "焦裕禄，山东博山人。1962 年临危受命到河南兰考担任县委书记时，正值内涝、风沙、盐碱「三害」肆虐。他带领群众战天斗地四百七十多天，直到肝癌晚期倒在了工作岗位上。",
    quote: "吃别人嚼过的馍没味道。",
    quoteNote: "—— 焦裕禄（鼓励干部深入一线调查研究的口头禅）",
    stories: [
      {
        t: "从工人到县委书记",
        p: "他出身贫寒，逃过荒、要过饭，参加过抗日游击队。新中国成立后，他进工厂、到矿山，「在困难面前逞英雄」。1962 年春，他主动请缨到兰考——那是当时全省最穷、灾害最重的县。",
      },
      {
        t: "战风沙、治盐碱",
        p: "到任后，他拖着肝病的身体，骑自行车跑了兰考的几十个大队，追着风沙走、顶着暴雨行。他和群众一起栽泡桐、压麦苗、修水利，总结出治理「三害」的具体办法。",
      },
      {
        t: "倒在岗位上",
        p: "他的肝病越来越重，疼起来就用钢笔、藤椅顶住肝部坚持工作。1964 年 5 月 14 日，他病逝于郑州，时年四十二岁。他临终前嘱托：「把我运回兰考，埋在沙丘上，看着兰考把沙丘治好。」",
      },
    ],
    legacy: "他当年亲手栽下的那棵泡桐，如今已长成参天大树，兰考人亲切地称它「焦桐」。1990 年，习近平总书记在福州任职时写下《念奴娇·追思焦裕禄》，让「焦裕禄精神」穿越时空、历久弥新。",
  },
  {
    slug: "yanggensi",
    name: "杨根思",
    years: "1922 — 1950",
    native: "江苏泰兴",
    epithet: "特级英雄 · 怀抱炸药包与敌同归于尽",
    lead:
      "杨根思，江苏泰兴人，中国人民志愿军第二十军五十八师一七二团三连连长。1950 年 11 月长津湖战役下碣隅里战斗中，他守小高岭、打退敌人八次进攻，最后抱起十斤重的炸药包冲入敌群，与四十余名敌人同归于尽，时年二十八岁。他是抗美援朝第一位特级英雄。",
    quote: "不相信有完不成的任务，不相信有克服不了的困难，不相信有战胜不了的敌人！",
    quoteNote: "—— 杨根思「三个不相信」誓言（朝鲜战场）",
    stories: [
      {
        t: "从泰兴到华东战场",
        p: "1944 年，他参加新四军，先后经历了抗日战争、解放战争，作战勇敢、屡建战功，被评为「华东一级人民英雄」。他曾在淮海战役中独自坚守一个阵地，掩护主力安全转移。",
      },
      {
        t: "小高岭的最后时刻",
        p: "1950 年 11 月 29 日凌晨，连队在长津湖下碣隅里以南的小高岭阻击美军王牌陆战一师。敌军发起的八次进攻均被击退，但阵地上仅剩他与两名伤员。弹药告罄之际，他抱起最后一个十斤重的炸药包冲入敌群。",
      },
      {
        t: "特级英雄与他身后的连队",
        p: "战后他被追记特等功、授「特级英雄」称号。他生前所在的三连，被中国人民志愿军总部命名为「杨根思连」，至今保留这个番号，是全军第一个以英雄名字命名的连队。",
      },
    ],
    legacy: "七十多年过去了，「三个不相信」仍回响在杨根思连的每一次列队点名里。新兵入连的第一课，就是在英雄画像前高声复诵那三句话。",
  },
  {
    slug: "baiqiuen",
    name: "白求恩",
    years: "1890 — 1939",
    native: "加拿大安大略",
    epithet: "国际主义医生 · 一个高尚的人，一个纯粹的人",
    lead:
      "诺尔曼·白求恩（Norman Bethune），加拿大安大略省人，著名的胸外科医生。1937 年中国全面抗战爆发后，他受加拿大共产党和美国共产党的派遣，率医疗队来到中国，在延安受到毛泽东接见，随后转赴晋察冀敌后抗日前线，救治了大量八路军伤病员。1939 年 11 月 12 日，他在河北唐县黄石口村因手术时割伤左手中指引发败血症逝世。",
    quote: "一个医生，一个护士，一个卫生员的责任是什么？只有一个责任。那责任就是使你的病人快乐，帮助他们恢复健康，恢复力量。",
    quoteNote: "—— 白求恩对晋察冀卫生工作者的讲话（一九三九年）",
    stories: [
      { t: "从蒙特利尔到延安", p: "白求恩毕业于多伦多大学医学院，是英联邦当时少数能独立完成肺叶切除术的胸外科医生之一。1937 年西班牙内战期间，他曾率加拿大志愿医疗队赴马德里前线。得知中国抗战消息后，他在纽约的国际援华委员会上宣布：「我绝不回北美去，我要留在中国，我要到前线去。」" },
      { t: "在抗日前线巡医", p: "1938 年春抵达延安，毛泽东在凤凰山麓的窑洞里接见了他。三个月后他东渡黄河，进入晋察冀敌后根据地。他边行军边为伤员做手术，创办模范医院、编写战地医疗教材，把西方的输血技术引入敌后——晋察冀军区因此成为八路军最早建立血站的部队。" },
      { t: "把生命留在唐县", p: "1939 年秋，在抢救一名患蜂窝组织炎的伤员时他割破左手中指。感染迅速扩散，他坚持工作直至昏迷。临终前他留下遗书：「请转告毛主席，感谢他和中国共产党给我的教育。我相信中国人民的解放事业一定会取得最后胜利。」" },
    ],
    legacy: "毛泽东写下《纪念白求恩》，号召全体党员学习他「毫不利己、专门利人」的精神。这篇文章从延安传到新中国，又随着教材进入几代人的课堂，「一个高尚的人，一个纯粹的人，一个有道德的人，一个脱离了低级趣味的人，一个有益于人民的人」成为中国人最熟悉的国际主义誓言。",
  },
  {
    slug: "liuzhidan",
    name: "刘志丹",
    years: "1903 — 1936",
    native: "陕西保安（今志丹）",
    epithet: "陕北红军之父 · 陕甘边根据地奠基者",
    lead:
      "刘志丹，陕北保安（今志丹县）人，中国工农红军高级将领，陕甘边革命根据地与陕北革命根据地的主要创建者。他把马克思主义真理同陕甘边具体实际相结合，探索出「武装夺取政权」的陕甘边道路，为党中央和红军长征提供了宝贵的落脚点。1936 年 4 月，他在率部东征作战时于山西中阳县三交镇战斗中牺牲，年仅三十三岁。",
    quote: "共产党员是在斗争中锻炼出来的，哪里有斗争我就到哪里去。",
    quoteNote: "—— 刘志丹（转引自《刘志丹文集》）",
    stories: [
      { t: "从黄埔到渭华", p: "刘志丹 1924 年成为陕北第一批共青团员，次年转入共产党。1926 年他从黄埔军校毕业，参加北伐。1928 年与谢子长、习仲勋等组织渭华起义，打响了西北地区武装反抗国民党反动派的第一枪。" },
      { t: "陕甘边的「狡兔三窟」", p: "在陕甘边，他创造性地建立以南梁为中心的革命根据地，发展出「狡兔三窟」式的红色区域——根据地、退步区、白区三种地带相互掩护。他把「红色」「灰色」「白色」三种力量结合，使陕甘边根据地成为土地革命战争后期全国仅存的两块根据地之一。" },
      { t: "东征的最后一战", p: "1936 年 2 月，他与聂荣臻、邓小平一起率领红二十八军渡黄河东征。4 月 14 日，在山西中阳县三交镇南一公里处指挥作战时，他被国民党军碉堡射出的子弹击中左胸，牺牲在黄河岸边。消息传回陕北，瓦窑堡会议决定将他牺牲的保安县改名为志丹县。" },
    ],
    legacy: "毛泽东为刘志丹题词「群众领袖，民族英雄」，周恩来题词「上下五千年，英雄万万千，人民的英雄，要数刘志丹」。他和陕甘边根据地一起，为 1935 年中央红军长征提供了关键落脚点——正如毛泽东所说：「刘志丹同志是在陕北根据地的创造者。」",
  },
  {
    slug: "xiangjingyu",
    name: "向警予",
    years: "1895 — 1928",
    native: "湖南溆浦",
    epithet: "中共早期重要领导人 · 中国妇女运动的先驱",
    lead:
      "向警予，湖南溆浦人，土家族，中国共产党早期重要领导人之一，杰出的妇女运动领袖。1919 年她与蔡和森在长沙结婚，后同赴法国勤工俭学，参与筹建中国共产党旅欧早期组织。她是中共第二、三届中央委员，主管妇女工作，主办《妇女周报》，被誉为「中国妇女运动的先驱」。1928 年 3 月 20 日在汉口法租界被捕，5 月 1 日英勇就义，年仅三十三岁，是中国共产党最早牺牲的女中央委员。",
    quote: "我为了我的信仰——共产主义，奋斗到了最后一滴血。请你们放心，我永远不会叛变革命。",
    quoteNote: "—— 向警予狱中遗言（一九二八年三月）",
    stories: [
      { t: "从溆浦女学到留法", p: "向警予幼年随父亲读新书，是湘西最早剪辫子的女性之一。她先后在常德女子速成师范和周南女校就读，1916 年回溆浦创办男女兼收的新式小学。1919 年赴法勤工俭学期间与蔡和森结为革命伴侣，在蒙达尼起草建党文件「猛进图书馆」讨论稿。" },
      { t: "在《妇女周报》上发声", p: "1922 年她从法国回国后投身妇女运动，主编《妇女周报》，发起「女界国民会议促成会」，号召妇女参加反帝反封建斗争。在中共二大上参与起草《关于妇女运动的决议》，这是中国共产党第一个关于妇女工作的专门文件。" },
      { t: "汉口的最后时光", p: "1927 年武汉国民政府反共后，她坚持地下斗争，在《长江》撰文继续宣传革命。1928 年因叛徒出卖在汉口法租界被捕，狱中两个月受尽酷刑仍不屈。被押赴刑场时，她高唱《国际歌》、高呼革命口号，沿途群众为之泪下。" },
    ],
    legacy: "毛泽东在延安时多次讲起向警予的英勇事迹，1939 年她在延安的「三八」纪念大会上被追念。2009 年她被评为「100 位为新中国成立作出突出贡献的英雄模范人物」。今天的人们记住她，不仅因为她是早期党的领导人，更因为她以一介湘西土家族女子之身，冲破旧社会对女性的所有束缚，把一生献给共产主义信仰。",
  },
  {
    slug: "wang-jinxi",
    name: "王进喜",
    years: "1923 — 1970",
    native: "甘肃玉门",
    epithet: "铁人 · 宁肯少活二十年，拼命也要拿下大油田",
    lead:
      "王进喜，甘肃玉门人，中国石油工人的杰出代表。1956 年加入中国共产党，1960 年率 1205 钻井队从玉门奔赴大庆参加石油会战，艰苦奋斗、勇挑重担，被人们尊称为「铁人」。",
    quote: "宁肯少活二十年，拼命也要拿下大油田。",
    quoteNote: "—— 王进喜（一九六〇年，会战誓师）",
    stories: [
      {
        t: "玉门起步",
        p: "王进喜幼年生活困苦，1938 年进玉门油矿当小工，解放后成为新中国第一代钻井工人。他率领 1205 钻井队创下全国钻井纪录，告别「中国贫油」的旧帽子，是从西部戈壁走出来的产业工人典型。",
      },
      {
        t: "人拉肩扛的会战",
        p: "1960 年春大庆石油会战打响，他率领队伍在零下四十度的荒原上靠人拉肩扛把 60 多吨的钻机从火车上卸下来。他跳进泥浆池用身体搅拌水泥压井喷，「铁人」之名由此传开。这场会战只用了三年便基本建成了中国最大的石油生产基地。",
      },
      {
        t: "铁人精神永流传",
        p: "他以「宁可少活二十年」自誓，拼命拿下大油田。1970 年 11 月 15 日，他因胃癌病逝，年仅 47 岁。「铁人精神」成为新中国工业战线的一面旗帜：爱国、创业、求实、奉献，激励着一代又一代的产业工人。",
      },
    ],
    legacy: "大庆建有铁人王进喜纪念馆，是全国爱国主义教育示范基地。「铁人」从未远离——它活在每一名扎根岗位、迎难而上的中国产业工人身上。",
  },
  {
    slug: "guwenchang",
    name: "谷文昌",
    years: "1915 — 1981",
    native: "河南林州（南下干部）",
    epithet: "东山县委书记的好榜样 · 让荒岛变绿洲",
    lead:
      "谷文昌，河南林州人，1944 年参加革命，1950 年随解放军南下到福建东山岛，担任县委书记十四年。他带领群众「上战秃头山，下战飞沙滩」，让昔日风沙肆虐的东山岛变成了「国家级生态示范区」。",
    quote: "不带私心搞革命，一心一意为人民。",
    quoteNote: "—— 谷文昌",
    stories: [
      {
        t: "南下到东山",
        p: "1950 年，谷文昌随解放军南下来到福建东山岛。东山全岛 330 平方公里，森林覆盖率不足 0.12%，一年六级以上大风近 150 天，解放前三年内有 2 万多人外出逃荒。风、沙、旱三害，困住了这座海岛。",
      },
      {
        t: "「上战秃头山，下战飞沙滩」",
        p: "他带领干部群众苦战十几个春秋：在沙滩上筑堤、种树、修水库、整良田，摸索出「筑堤、种草、种树、治沙」一整套办法，硬是把 3 万多亩流沙治住，让全岛披上绿装。东山百姓从此不再背井离乡，荒岛变成了绿洲。",
      },
      {
        t: "「先祭谷公，后祭祖宗」",
        p: "他身患重病仍坚持工作，常常到田头、地边、农户家中调研。他始终坚持「当领导的要把自己的手洗净，把自己的腰挺直」，把党和政府的关怀切实送到百姓心里。东山群众自发形成了「先祭谷公，后祭祖宗」的民间习俗。",
      },
    ],
    legacy: "1981 年谷文昌病逝，享年 66 岁。2015 年，习近平总书记在会见全国优秀县委书记时专门点赞谷文昌，称他是「县委书记的好榜样」。",
  },
];
